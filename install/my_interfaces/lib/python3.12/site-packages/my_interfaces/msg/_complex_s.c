...
bool my_interfaces__msg__complex__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._complex.Complex", full_classname_dest, 34) == 0);
  }
  my_interfaces__msg__Complex * ros_message = _ros_message;
  {  // real
    ...
    ros_message->real = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // imaginary
    ...
    assert(PyFloat_Check(field));
    ros_message->imaginary = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * my_interfaces__msg__complex__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._complex");
