...
from launch.actions import (
    ...
    TimerAction,
    LogInfo,               # <- you already had this, just keeping it here
)
...
def generate_launch_description():
    ...
    mecanum = LaunchConfiguration("mecanum", default="False")
    ...
    # ---------- DEBUG: show which controller config file is actually used ----------
    debug_controller_cfg = LogInfo(
        msg=[
            "\n[controller.launch.py DEBUG]\n",
            "config_search_path      = ", config_search_path, "\n",
            "robot_model             = ", robot_model, "\n",
            "base_controller_prefix  = ", base_controller_prefix, "\n",
            "manipulator_prefix      = ", manipulator_prefix, "\n",
            "controller_config_file  = ", controller_config_file, "\n",
            "controller_config (full)= ", controller_config, "\n",
        ]
    )
    # ----------------------------------------------------------------------------- #
    ...
    return LaunchDescription(
        [
            ...
            declare_mecanum_arg,  # mecanum based on robot_model arg
            debug_controller_cfg,  # <--- DEBUG output happens early in the launch
            load_urdf,
            control_node,
            delayed_controllers,
