...
class TelloNode():
    ...
    def setup_publishers(self):
        self.pub_image_raw = self.node.create_publisher(Image, 'camera/image_raw', 1)
        self.pub_camera_info = self.node.create_publisher(CameraInfo, 'camera/camera_info', 1)
    ...
    def setup_subscribers(self):
        ...
        self.sub_control = self.node.create_subscription(Twist, 'cmd_vel', self.cb_control, 1)
...
def main(args=None):
    ...
    node = rclpy.create_node('tello_node_1')
