...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/urdf', ['urdf/ur5_robotiq.xacro', 'urdf/ur5_robotiq_macro.xacro', 'urdf/ur_gz.xacro', 'urdf/hole.urdf']),
        ('share/' + package_name + '/worlds', ['worlds/empty.sdf']),
        ('share/' + package_name + '/models', ['models/hole.stl', 'models/peg.stl', 'models/hole.sdf']),
    ...
    entry_points={
        'console_scripts': [
            'spawn_hole_random = ur5_robotiq.spawn_hole_random:main',
        ],
    },
)
