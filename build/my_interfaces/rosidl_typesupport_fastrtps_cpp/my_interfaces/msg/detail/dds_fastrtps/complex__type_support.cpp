...
#include "my_interfaces/msg/detail/complex__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::Complex & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::Complex & ros_message)
{
  // Member: real
  cdr >> ros_message.real;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::Complex;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_interfaces
max_serialized_size_key_Complex(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::Complex *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::Complex *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_Complex__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, Complex)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_Complex__handle;
}
